    ...
    <section className={cn("", bg, text)}>
      <div className="site-container">
        ...
        <div className="relative mt-12">
          <div className="absolute left-0 right-0 top-12 hidden h-1 bg-[linear-gradient(90deg,rgba(63,115,201,0.12),rgba(67,179,233,0.28),rgba(63,115,201,0.12))] lg:block" />
          ...
          <div className="grid gap-5 lg:grid-cols-4">
            {steps.map((step, index) => (
              ...
              >
                <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-full border border-(--brand-primary)/14 bg-[linear-gradient(135deg,rgba(63,115,201,0.12),rgba(67,179,233,0.2))] text-sm font-semibold text-(--brand-primary)">
                  0{index + 1}
                </div>
