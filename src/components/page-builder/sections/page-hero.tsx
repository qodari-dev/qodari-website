    ...
    >
      ...
      <div className="site-container relative grid gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)] lg:items-end lg:gap-12">
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(67,179,233,0.12),transparent_68%)] blur-3xl" />
              ...
              {heroHighlights.map((item, index) => (
                ...
                >
                  <div className="mb-4 flex items-center justify-between">
                    <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-[linear-gradient(135deg,rgba(63,115,201,0.12),rgba(67,179,233,0.2))] text-[13px] font-semibold text-(--brand-primary)">
                      0{index + 1}
                    </span>
